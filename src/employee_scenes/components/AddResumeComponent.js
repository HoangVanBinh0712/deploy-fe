      ...
      <div className="free-space" id="free-space">
        <div className="content-wrapper">
          <div className="input-wrapper">
            ...
            <input className="coler-placeholder" type="text" onChange={onChangeNameinput} placeholder={mess} value={name}></input>
          </div>
          <div className="double-select">
            <div className="select">
              <div className="label">Public</div>
              <select name="isPublic" id="" onChange={onChangeIsPublicinput}>
                <option value="true" selected={isPublic}>
                  True
                </option>
                <option value="false" selected={!isPublic}>
                  False
                </option>
              </select>
            </div>
          ...
          <div className="double-select">
            <div className="select">
              ...
              <select name="" id="" onChange={onChangePositioninput}>
                ...
                <option value="Interns" selected={position === "Interns"}>
                  Interns
                </option>
